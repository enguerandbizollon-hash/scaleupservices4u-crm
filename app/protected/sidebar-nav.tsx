...
const NAV = [
  ...
  { href:"/protected/agenda",        label:"Agenda",        dot:"#6D28D9", bg:"rgba(109,40,217,.18)",  icon:CalendarDays },
  { href:"/protected/import",        label:"Import",        dot:"#1E7A4A", bg:"rgba(30,122,74,.18)",   icon:Upload },
  { href:"/protected/connecteurs",   label:"Connecteurs",   dot:"#DC2626", bg:"rgba(220,38,38,.18)",   icon:Plug },
];

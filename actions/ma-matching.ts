...
// getMaTargetMatches (sens deal ma_buy -> cibles de l'annuaire) : supprimé.
// Le sens buy vit dans l'onglet Cibles de la fiche mandat (chasses rattachées
// + funnel d'approche), plus dans un matching de l'annuaire interne.
